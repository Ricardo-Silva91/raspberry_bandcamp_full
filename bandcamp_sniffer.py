...
def sniff(browser, display, data, data_file, args_file, time_to_sniff):
    ...
    time_elapsed = time.time() - initial_instant

    while time_elapsed < time_to_sniff:
...
def bandcamp_sniffer_for_import(file, display, browser, time_to_sniff):
    # parser = get_parser()
    ...
    if not args['file'] == 'None':
        ...
        print(display)
        sniff(args['browser'], args['display'], data, data_file, args['file'], time_to_sniff)
